...
<figure markdown="1">
![A cartoon of a vinyl record, iPad, hardbound book, laptop, and pencil joining hands together]({{ site.baseurl }}/images/assets/why-vinyl/digital-and-analog-friends.png){: .edge-to-edge .medium .no-shadow }
</figure>
...
<figure markdown="1">
![Wordsworth's "My Heart Leaps Up" written in cursive on paper]({{ site.baseurl }}/images/assets/why-vinyl/my-heart-leaps-up.jpg){: .inline .no-shadow }
</figure>
