...
<ul id="blog-footer-buttons" class="button-group" style="text-align:left;padding-bottom:0;">
    <li style="margin-left:0;width:auto;"><a href="/articles/fourth-annual-ios-music-player-showcase/20"><p class="button">Final Section: “Conclusion”</p></a></li>
</ul>
                ...
                <ul>
                    ...
                    <li>Established
                        <ul>
                            ...
                            <li><a href="/articles/fourth-annual-ios-music-player-showcase/19">Vinyl Fetish</a></li>
                        </ul>
                    </li>
                </ul>
            </li>
