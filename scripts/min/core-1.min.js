...
menu.addClass("hide-when-scrolling-on-larger-screens");
}
if ($(this).scrollTop() > 125) {
menu.addClass("hide-when-scrolling-on-small-screens");
...
menu.removeClass("hide-when-scrolling-on-larger-screens");
}
if (newScrollTop > 125) {
menu.addClass("hide-when-scrolling-on-small-screens");
html.addClass("float-menu-for-hiding");
...
html.addClass("float-menu-for-hiding");
menu.removeClass("hide-when-scrolling-on-small-screens");
} else if (newScrollTop <= 100) {
menu.removeClass("hide-when-scrolling-on-small-screens");
