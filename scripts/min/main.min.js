...
$(document).ready(function(){$('h2').anchor({symbol:'#'});$('h3').anchor({symbol:'#'});});
...
$.bigfoot({actionOriginalFN:"ignore",numberResetSelector:"article"});
