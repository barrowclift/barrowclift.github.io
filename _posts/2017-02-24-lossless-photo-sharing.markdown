...
card:
    image: "lossless-photo-sharing/card"
---

<div class="edge-to-edge small">
    <img src="{{ site.dropbox }}/lossless-photo-sharing/what-to-choose.png" alt="A cartoon of me with analysis paralysis while looking at a pile of different photo service icons, including Dropbox, iCloud Photo Sharing, Flickr, and many more" title="Decisions, decisions…">
</div>
