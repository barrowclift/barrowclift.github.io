...
<figure markdown="1">
![A cartoon of me with analysis paralysis while looking at a pile of different photo service icons, including Dropbox, iCloud Photo Sharing, Flickr, and many more]({{ site.baseurl }}/images/assets/lossless-photo-sharing/what-to-choose.png "Decisions, decisions..."){: .edge-to-edge .small }
</figure>
...
<figure markdown="1">
[![The Dropbox logo]({{ site.baseurl }}/images/assets/lossless-photo-sharing/dropbox.svg){: .half-inline }](https://www.dropbox.com)
</figure>
...
<figure markdown="1">
[![The Google Photos logo]({{ site.baseurl }}/images/assets/lossless-photo-sharing/google-photos.svg){: .half-inline }](https://photos.google.com)
</figure>
