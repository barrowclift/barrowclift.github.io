...
![]({{ site.dropbox }}/eulogy-for-a-good-icon/tower-3-beta-signup-page.jpg)
</div>
...
![]({{ site.dropbox }}/eulogy-for-a-good-icon/bad-os-x-icons.png)
<figcaption>
...
![]({{ site.dropbox }}/eulogy-for-a-good-icon/snow-leopard-dock.png)
</div>
...
<figure markdown="1" class="inline three-fours-size">
![]({{ site.dropbox }}/eulogy-for-a-good-icon/os-x-color-palettes.png){: .show-when-light }
![]({{ site.dropbox }}/eulogy-for-a-good-icon/os-x-color-palettes-dark.png){: .show-when-dark }
...
<figure markdown="1" class="edge-to-edge medium">
![]({{ site.dropbox }}/eulogy-for-a-good-icon/lighting-comparison.png){: .show-when-light }
![]({{ site.dropbox }}/eulogy-for-a-good-icon/lighting-comparison-dark.png){: .show-when-dark }
</figure>
...
<figure markdown="1" class="edge-to-edge medium">
![]({{ site.dropbox }}/eulogy-for-a-good-icon/app-genres.png){: .show-when-light }
![]({{ site.dropbox }}/eulogy-for-a-good-icon/app-genres-dark.png){: .show-when-dark }
</figure>
...
![]({{ site.dropbox }}/eulogy-for-a-good-icon/high-sierra-dock.png){: .show-when-light }
![]({{ site.dropbox }}/eulogy-for-a-good-icon/high-sierra-dock-dark.png){: .show-when-dark }
</figure>
...
![]({{ site.dropbox }}/eulogy-for-a-good-icon/macos-color-palettes.png){: .show-when-light }
![]({{ site.dropbox }}/eulogy-for-a-good-icon/macos-color-palettes-dark.png){: .show-when-dark }
<figcaption>Palettes generated by <a href="https://www.canva.com/color-palette/">canva.com</a>.</figcaption>
</figure>
...
<figure markdown="1" class="edge-to-edge medium">
![]({{ site.dropbox }}/eulogy-for-a-good-icon/system-preferences-lit-and-unlit.png)
...
![]({{ site.dropbox }}/eulogy-for-a-good-icon/tower-3-icon.png)
</figure>
...
![]({{ site.dropbox }}/eulogy-for-a-good-icon/shadow-and-border-comparison.png)
</div>
