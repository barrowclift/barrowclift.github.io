...
card:
    image: "multitasking-misconceptions/card"
---
...
<div class="edge-to-edge medium">
    <img src="{{ site.dropbox }}/multitasking-misconceptions/panel-2-colored.png" alt="The second panel of the cartoon where the Memory card says &quot;I'm full, this is your problem now, slow poke storage!&quot; to the sheepish looking Storage disk" title="What did I tell you, Storage?">
</div>
...
<div class="edge-to-edge medium">
    <img src="{{ site.dropbox }}/multitasking-misconceptions/panel-3-colored.png" alt="The third panel of the cartoon has a bunch of apps fighting for the panicked CPU's attention with a battery fuel gauge nearing empty" title="Apps can be annoying little buggers sometimes.">
</div>
...
<div class="edge-to-edge medium">
    <img src="{{ site.dropbox }}/multitasking-misconceptions/panel-4-colored.png" alt="The fourth panel of the cartoon has the CPU easily managing one app's requests with a full reserve of battery to power him)" title="And with ample battery to spare">
</div>
...
<div class="edge-to-edge medium">
    <img src="{{ site.dropbox }}/multitasking-misconceptions/panel-5-colored.png" alt="The fifth panel of the cartoon has the Memory card taking control with the power of iOS and demanding the eldest and least used app has got to go)" title="Out with the old, in with the new.">
</div>
...
<div class="edge-to-edge large three-images ios-screenshot">
    <img src="{{ site.dropbox }}/multitasking-misconceptions/settings.jpg" alt="iOS Settings Screen, General list item highlighted">
    <img src="{{ site.dropbox }}/multitasking-misconceptions/general.jpg" alt="iOS General Settings Screen, Usage list item highlighted">
    <img src="{{ site.dropbox }}/multitasking-misconceptions/background-app-refresh.jpg" alt="iOS Usage Settings Screen, both Manage Storage list items highlighted">
</div>
