...
![iOS Settings Screen, General list item highlighted]({{ site.dropbox }}/home-sweet-home/settings.jpg)
![iOS General Settings Screen, Usage list item highlighted]({{ site.dropbox }}/home-sweet-home/general.jpg)
![iOS Usage Settings Screen, both Manage Storage list items highlighted]({{ site.dropbox }}/home-sweet-home/usage.jpg)
</div>
...
![iOS app folder called Creative, page 1 contains Notability, Pages, Notes, Day One, Reminders, Hyperlapse, GarageBand, Coda, and Voice Memos]({{ site.dropbox }}/home-sweet-home/creative-folder-page-1.png)
![iOS app folder called Creative, page 2 contains PocketCAS, Scanner Pro, Dropbox, Obscura, Pixelmator, Metronome, and Numerical]({{ site.dropbox }}/home-sweet-home/creative-folder-page-2.png)
</div>

* __Games__: You guessed it, all games go here with the most played ones in the first page, nothing else to it, really.

<div markdown="1" class="edge-to-edge large two-images">
![iOS app folder called Games, page 1 contains Threes, Impossible, RaceTheSun, Alto, Smash Hit, Tiny Wings, Monument, #sworcery, and BADLAND]({{ site.dropbox }}/home-sweet-home/games-folder-page-1.png)
![iOS app folder called Games, page 2 contains The Roow Two, Minecraft PE, Dude Where's My Water, Temple Run 2, Cube Runner, Duet, Crossy Road, Shades, and Jetpack]({{ site.dropbox }}/home-sweet-home/games-folder-page-2.png)
</div>
...
<div markdown="1" class="edge-to-edge large two-images">
![iOS app folder called Media, page 1 contains Genius, Kodi Remote, Videos, iBooks, Cesium, Photos, Netflix, Barrowclift.me web shortcut, and Music]({{ site.dropbox }}/home-sweet-home/media-folder.png)
</div>
...
<div markdown="1" class="edge-to-edge large two-images">
![iOS app folder called Services, page 1 contains TD Bank, Maps, Capital One, Mail, Settings, TestFlight, Apple Watch, Activity, and App Store]({{ site.dropbox }}/home-sweet-home/services-folder-page-1.png)
![iOS app folder called Services, page 2 contains Wunderground, GrubHub, FaceTime, Phone, Passbook, Health, Adobe Acrobat, Wallet, and Southwest]({{ site.dropbox }}/home-sweet-home/services-folder-page-2.png)
</div>
...
![My iOS Homescreen, contains folders Creative, Games, Media, and Services in the first row, then Tumblr, Tweetbot, narwhal, Paper, Unread, Instapaper, MiniHack, DN Paper, Weather Line, Calendar, Vesper, and Ecoute. In the dock there are Messages, Safari, and Overcast]({{ site.dropbox }}/home-sweet-home/home-screen.jpg)
</div>
