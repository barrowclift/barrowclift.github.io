...
<figure markdown="1">
[![Pokémon screen shot with "Welcome to the Cable Club!" text bubble]({{ site.baseurl }}/images/assets/fearful-computing/cable-club.jpg){: .bound-responsive}]({{ site.baseurl }}/images/assets/fearful-computing/cable-club.jpg "Oh god it begins...")
</figure>
