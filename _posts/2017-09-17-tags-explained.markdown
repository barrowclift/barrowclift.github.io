...
<figure markdown="1">
![An array of seven colored dots, the visual metaphor used by macOS to represent tags]({{ site.baseurl }}/images/assets/tags-explained/hero.svg){: .inline .no-shadow }
</figure>
...
<figure markdown="1">
[![A sketch showing the file duplicates required to get the same organizational result with Folders, compared to Tags where no duplicates are necessary]({{ site.baseurl }}/images/assets/tags-explained/folders-vs-tags-sketch.png){: .edge-to-edge .medium .no-shadow }]({{ site.baseurl }}/images/assets/tags-explained/folders-vs-tags-sketch.png)
</figure>
