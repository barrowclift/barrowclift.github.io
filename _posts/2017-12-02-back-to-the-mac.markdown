...
<figure markdown="1">
<p>
<video controls preload="metadata" poster="/videos/assets/back-to-the-mac/emoji-picker-poster.jpg" alt="Video demonstrating the macOS emoji picker" class="edge-to-edge medium">
...
<figure markdown="1">
[![Image showing the macOS menu bar clock with the date displayed alongside the time]({{ site.baseurl }}/images/assets/back-to-the-mac/menu-bar-date.jpg){: .edge-to-edge .small .menu-bar }]({{ site.baseurl }}/images/assets/back-to-the-mac/menu-bar-date.jpg)
</figure>
...
<figure markdown="1">
<p>
<video controls preload="metadata" poster="/videos/assets/back-to-the-mac/quicklook-poster.jpg" alt="Video demonstrating the benefits of Quicktime" class="edge-to-edge medium">
...
<figure markdown="1">
<p>
<video controls preload="metadata" poster="/videos/assets/back-to-the-mac/spotlight-calculator-poster.jpg" alt="Video demonstrating the Spotlight being used for basic calculations" class="edge-to-edge medium">
...
<figure markdown="1">
<p>
<video controls preload="metadata" poster="/videos/assets/back-to-the-mac/tap-to-define-poster.jpg" alt="Video showcasing macOS's 'tap to define' feature" class="edge-to-edge medium">
...
<figure markdown="1">
![Image of Windows File Explorer screenshot. If you have difficulties seeing, or the image didn't load for some reason, just take my word for it that it looks like ass]({{ site.baseurl }}/images/assets/fearful-computing/internet-explorer.png){: .inline .no-border-radius }
<figcaption>
...
<figure markdown="1">
![Image of a lovely macOS window screenshot]({{ site.baseurl }}/images/assets/back-to-the-mac/screenshot-example.png){: .inline .macos-screenshot .textedit }
</figure>
...
<figure markdown="1">
![Image of the screen recording Quicktime window]({{ site.baseurl }}/images/assets/back-to-the-mac/quicktime-screen-recording.png){: .inline .macos-screenshot .quicktime }
</figure>
...
<figure markdown="1">
<p>
<video controls preload="metadata" poster="/videos/assets/back-to-the-mac/text-navigation-poster.jpg" alt="Video demonstrating mastery over macOS's text navigation shortcuts" class="edge-to-edge medium">
...
<figure markdown="1">
<p>
<video controls preload="metadata" poster="/videos/assets/back-to-the-mac/switch-tabs-shortcut-poster.jpg" alt="Video showing how you can quickly switch between tabs with the keyboard shortcut" class="edge-to-edge medium">
...
<figure markdown="1">
<p>
<video controls preload="metadata" poster="/videos/assets/back-to-the-mac/tab-shortcut-comparison-poster.jpg" alt="Video showing tab switching and tab closing shortcuts executed together" class="edge-to-edge medium">
...
<figure markdown="1">
![Image of the text substitutions System Preferences pane]({{ site.baseurl }}/images/assets/back-to-the-mac/custom-autocorrect-settings.png){: .inline .macos-screenshot }
</figure>
...
<figure markdown="1">
<p>
<video controls preload="metadata" poster="/videos/assets/back-to-the-mac/text-substitution-poster.jpg" alt="Video showing the custom autocorrection in action" class="edge-to-edge medium">
...
<figure markdown="1">
![Image of the default Finder toolbar]({{ site.baseurl }}/images/assets/back-to-the-mac/finder-default.png){: .inline .macos-screenshot }
</figure>
...
<figure markdown="1">
![Image of the Finder toolbar customization pane]({{ site.baseurl }}/images/assets/back-to-the-mac/customize-toolbar-sheet.png){: .inline .macos-screenshot }
</figure>
...
<figure markdown="1">
![Image of my customized Finder toolbar]({{ site.baseurl }}/images/assets/back-to-the-mac/finder-custom.png){: .inline .macos-screenshot }
</figure>
...
<figure markdown="1">
![Image of the default Mail Compose toolbar]({{ site.baseurl }}/images/assets/back-to-the-mac/mail-default.png){: .inline .macos-screenshot }
<figcaption>
Default
</figcaption>
</figure>
...
<figure markdown="1">
![Image of my custom Mail Compose toolbar]({{ site.baseurl }}/images/assets/back-to-the-mac/mail-custom.png){: .inline .macos-screenshot }
<figcaption>
Custom
</figcaption>
</figure>
...
<figure markdown="1">
![Image of the finder Preferences window]({{ site.baseurl }}/images/assets/back-to-the-mac/finder-preferences.png){: .inline .finder-preferences .macos-screenshot }
</figure>
...
<figure markdown="1">
![Image showing Auto the Automator robot and Wall-E's Eve side-by-side]({{ site.baseurl }}/images/assets/back-to-the-mac/automator-and-eve.png){: .inline }
</figure>
...
<figure markdown="1">
<p>
<video controls preload="metadata" poster="/videos/assets/back-to-the-mac/services-poster.jpg" alt="Video showing where the Automator services are located" class="edge-to-edge medium">
...
<figure markdown="1">
![Loads of Finder "Get Info" windows, LOADS OF THEM]({{ site.baseurl }}/images/assets/back-to-the-mac/death-by-get-info.jpg){: .edge-to-edge .large }
<figcaption>
God dammit, Apple...
</figcaption>
</figure>
...
<figure markdown="1">
![The consolidated Finder "Get Info" window]({{ site.baseurl }}/images/assets/back-to-the-mac/consolidated-get-info-window.png){: .inline .get-info .macos-screenshot }
</figure>
...
<figure markdown="1">
<p>
<video controls preload="metadata" poster="/videos/assets/back-to-the-mac/itunes-mini-players-poster.jpg" alt="Video comparing the new and old iTunes mini-players" class="edge-to-edge large">
...
<figure markdown="1">
![Image of my desktop with Dark Mode enabled]({{ site.baseurl }}/images/assets/back-to-the-mac/dark-mode.jpg){: .edge-to-edge .large }
</figure>
...
<figure markdown="1">
<p>
<video controls preload="metadata" poster="/videos/assets/back-to-the-mac/menu-bar-arrange-poster.jpg" alt="Video showcasing menu bar icon rearrangement" class="inline menu-bar-arrange">
...
[^i-guess]: <figure style="margin-bottom:0;"><div class="special-footer-struct"></div><p style="text-align:left;"><a href="http://www.gunshowcomic.com/367"><img alt="I GUESS" class="i-guess" src="{{ site.baseurl }}/images/assets/back-to-the-mac/i-guess.png" /></a></p></figure>
...
[^dock]: <figure style="margin-bottom:0;"><div class="special-footer-struct large"></div><p style="text-align:left;"><img alt="MacBook screenshot showcasing the space taken up by the Dock" class="macbook" src="{{ site.baseurl }}/images/assets/back-to-the-mac/macbook-dock.jpg"/></p></figure>
