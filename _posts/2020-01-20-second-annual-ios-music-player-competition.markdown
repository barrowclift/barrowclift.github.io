...
### !["Starling" iOS app icon]({{ site.dropbox }}/second-annual-ios-music-player-competition/starling/icon.png '"Starling" iOS app icon'){: .app-icon } Starling
...
<div class="show-when-dark edge-to-edge large array ios-screenshot">
    ...
    <a markdown="1" href="{{ site.dropbox }}/second-annual-ios-music-player-competition/soor/dark-now-playing.jpg">
        ![Image of "Soor" dark now playing view]({{ site.dropbox }}/second-annual-ios-music-player-competition/soor/dark-now-playing.jpg '"Soor" dark now playing view')
    </a>
</div>
...
<div class="show-when-dark edge-to-edge large array ios-screenshot">
    ...
    <a markdown="1" href="{{ site.dropbox }}/second-annual-ios-music-player-competition/albums/dark-now-playing.jpg">
...
<div class="show-when-dark edge-to-edge large array ios-screenshot">
    ...
    <a markdown="1" href="{{ site.dropbox }}/second-annual-ios-music-player-competition/cs/dark-album-view.jpg">
        ![Image of "Cs" dark album view]({{ site.dropbox }}/second-annual-ios-music-player-competition/cs/dark-album-view.jpg '"Cs" dark album view')
    </a>
...
So we now have Cs 5 __and__ Cs 6 (which was later rebranded as ["SongOwl"](https://apps.apple.com/us/app/songowl/id1492630850) for release on February 2nd). Yikes.
...
<div class="show-when-light edge-to-edge large array ios-screenshot">
    ...
    <a markdown="1" href="{{ site.dropbox }}/second-annual-ios-music-player-competition/power-player/light-now-playing.jpg">
...
<div class="show-when-dark array ios-screenshot">
    ...
    <a markdown="1" href="{{ site.dropbox }}/second-annual-ios-music-player-competition/power-player/dark-album-view-2.jpg">
...
<div class="edge-to-edge large array ios-screenshot">
    ...
    <a markdown="1" href="{{ site.dropbox }}/second-annual-ios-music-player-competition/vox/album-view.jpg">
        ![Image of "VOX" album view]({{ site.dropbox }}/second-annual-ios-music-player-competition/vox/album-view.jpg '"VOX" album view')
    </a>
    <a markdown="1" href="{{ site.dropbox }}/second-annual-ios-music-player-competition/vox/now-playing.jpg">
        ![Image of "VOX" now playing view]({{ site.dropbox }}/second-annual-ios-music-player-competition/vox/now-playing.jpg '"VOX" now playing view')
    </a>
</div>
...
__:trophy: Winners: [!["Music.app" iOS app icon]({{ site.dropbox }}/second-annual-ios-music-player-competition/music-app/icon.png '"Music.app" iOS app icon'){: .app-icon } Music.app](https://www.apple.com/apple-music/)__ on iPhone, __[!["Power Player" iOS app icon]({{ site.dropbox }}/second-annual-ios-music-player-competition/power-player/icon.png '"Power Player" iOS app icon'){: .app-icon } Power Player](https://powerplayer.evenwerk.com)__ on iPad
...
__:trophy: Winner: [!["Doppi" iOS app icon]({{ site.dropbox }}/second-annual-ios-music-player-competition/doppi/icon.png '"Doppi" iOS app icon'){: .app-icon } Doppi](https://doppi.app)__
...
__:trophy: Winner: [!["Power Player" iOS app icon]({{ site.dropbox }}/second-annual-ios-music-player-competition/power-player/icon.png '"Power Player" iOS app icon'){: .app-icon } Power Player](https://powerplayer.evenwerk.com)__
...
__:trophy: Winner: [!["Marvis Pro" iOS app icon]({{ site.dropbox }}/second-annual-ios-music-player-competition/marvis-pro/icon.png '"Marvis Pro" iOS app icon'){: .app-icon } Marvis Pro](https://appaddy.wixsite.com/marvis)__
...
Enough about what I think, what were *your* favorite iOS music players this year? Are there any I missed, or any corrections or insights you'd like to provide? Feel free to "at" me with my [Twitter](https://twitter.com) handle [@Barrowclift](https://twitter.com/Barrowclift) or email me at <{{ site.author.email }}>, I'd love to hear from you! Thanks so much for your support, and happy new year. :tada:
